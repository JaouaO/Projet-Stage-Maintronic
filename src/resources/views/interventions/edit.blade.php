...
@section('content')
    ...
    <div style="max-width:980px;margin:16px auto;padding:12px;">
            ...
            <div style="padding:12px">
                ...
                <div style="display:flex;gap:8px;margin-top:8px;align-items:center;">
                    <button id="btnEdit" type="button"
                            style="padding:6px 10px;border:1px solid #e5e7eb;border-radius:6px;background:#fff">Modifier
                    </button>
                    <button id="btnSave" type="button"
                            style="padding:6px 10px;border:1px solid #cfe0ff;border-radius:6px;background:#e8f1ff;display:none;">
                        Enregistrer
                    </button>
                    <button id="btnCancel" type="button"
                            style="padding:6px 10px;border:1px solid #e5e7eb;border-radius:6px;background:#fff;display:none;">
                        Annuler
                    </button>
        ...
        @if(session('success'))
            <div
                style="margin-top:12px;padding:8px;border:1px solid #cfe0ff;background:#e8f1ff;border-radius:6px;color:#143b7a">
                {{ session('success') }}
            </div>
        @endif
        @if(session('error'))
            <div
                style="margin-top:12px;padding:8px;border:1px solid #f7caca;background:#ffecec;border-radius:6px;color:#7a1d27">
                {{ session('error') }}
            </div>
        @endif
        @if ($errors->any())
